...
<div id="search">
<div class="cp_iptxt">
	<input type="text" v-model="keyword" placeholder="何かお困りですか">
<i class="fa fa-search fa-lg fa-fw" aria-hidden="true"></i>
    <table class="table" v-if="keyword !== ''">
    <tr v-for="user in filteredUsers" :key="user.url">
      <td>
        もしかして: <a :href="user.url">{{ user.name }}</a>
      </td>
    </tr>
  </table>
</div>
      ...
      <div class="triangle"></div>
        ...
        <a href="/lost" class="buttonRound">財布を忘れた</a>
       </div>
  
        <div class="buttoncenter">
        <a href="/lost2" class="buttonRound">忘れ物をした</a>
       </div>
  ...
  computed: {
    filteredUsers() {
      ...
      return this.users.filter(
        ...
        user.url.toLowerCase().includes(keyword)
      );
    }
  }
};

createApp().mount('#search');
...
:root {
  ...
  *:after {
  ...
  .triangle{
    ...
    border-top: 30px solid rgb(21, 20, 73);
  }
